        ...
        <div class="col-xl-7 col-lg-5">
            <div class="card">
                <div class="card-header">
                    <h6 class="font-weight-bold text-primary mt-2">publish Blog</h6>
                ...
                <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <textarea class="form-control" placeholder="Body" name="blog_body" id="blog" rows="2" required></textarea>
                        </div>
                        <div class="mb-3">
...
if (isset($_POST['add_blog'])) {
    ...
    if (in_array($image_ext, $allow_type)) {
        if ($size <= 2000000) {
            ...
            $sql2 = "INSERT INTO blog(blog_title,blog_body,blog_image,category,author_id) VALUES('$title','$body','$body','$filename',$category','$author_id')";
